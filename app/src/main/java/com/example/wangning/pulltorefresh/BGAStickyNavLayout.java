...
public class BGAStickyNavLayout extends LinearLayout {
     ...
     * @since JDK 1.7
     */
    public static class HomePageRefreshViewHolder extends BGARefreshViewHolder {
        ...
        public View getRefreshHeaderView() {
            if (mRefreshHeaderView == null) {
                mRefreshHeaderView = inflate(mContext, R.layout.view_refresh_header_home_page, null);
        ...
        public void changeToPullDown() {
            mHeaderStatusTv.setText(mPullDownRefreshText);
            mHeaderChrysanthemumIv.setVisibility(INVISIBLE);
            mHeaderChrysanthemumAd.stop();
            mHeaderArrowIv.setVisibility(INVISIBLE);
        ...
        public void changeToRefreshing() {
            ...
            mHeaderArrowIv.setVisibility(INVISIBLE);
            mHeaderChrysanthemumIv.setVisibility(VISIBLE);

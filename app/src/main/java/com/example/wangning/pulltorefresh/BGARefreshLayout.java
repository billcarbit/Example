            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (mCustomHeaderView != null) {
                        ...
                        Log.e("ACTION_DOWN","mWholeHeaderViewDownPaddingTop="+mWholeHeaderViewDownPaddingTop);
                    }

                    if (mCustomHeaderView == null || !mIsCustomHeaderViewScrollable) {
                        mRefreshDownY = (int) event.getY();
                        Log.e("ACTION_DOWN","A,mRefreshDownY="+mRefreshDownY);
                    }
                    if (isWholeHeaderViewCompleteInvisible()) {
                        mRefreshDownY = (int) event.getY();
                        Log.e("ACTION_DOWN","B,mRefreshDownY="+mRefreshDownY);
                        return true;
                    }
                    break;
                case MotionEvent.ACTION_MOVE:
    ...
    private void hiddenRefreshHeaderView() {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                mRefreshScaleDelegate.onHideRefreshView();
            }

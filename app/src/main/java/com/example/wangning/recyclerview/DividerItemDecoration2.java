...
public class DividerItemDecoration2 extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerItemDecoration2(Context context, int orientation, Drawable dividerDrawable) {
    ...
    public void setDividerLeft(int left) {
        mLeft = left;
    }

    public void setDividerRight(int right) {
        mRight = right;
    }

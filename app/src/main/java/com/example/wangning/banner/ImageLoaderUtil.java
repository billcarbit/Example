...
public class ImageLoaderUtil {
    ...
    private static final int PLACEHOLDER_DEFAULT = R.drawable.loading_picture;
    ...
    public static <T>  void displayBigPhoto(T model, ImageView imageView) {
       displayBigPhoto(model,imageView,-1);
    }

    public static <T>  void displayBigPhoto(T model, ImageView imageView, @DrawableRes int placeholder) {
        if (imageView == null) {
            return;
        }
        getBitmapNoRequestBuilder(model, imageView, getPlaceholder(placeholder))

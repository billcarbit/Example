...
public class GalleryBannerActivity extends Activity {
    ...
    private void initViewPager() {
        ...
        Log.e("AA", "initViewPager: width=" + width);
        mViewPagerContainer.measure(0, 0);
        height = mViewPagerContainer.getMeasuredHeight();
        // width = mViewPagerContainer.getMeasuredWidth();
        //设置ViewPager的布局
        //338.9/375
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                (int) (width * 338.9 / (float)375.0),
                height * 6 / 10);
        ...
        mViewPager.setPageMargin(AppUtil.dp2px(this,40));// TODO: 2018/1/11
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ImageView imageView = new ImageView(GalleryBannerActivity.this);
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setImageResource(R.drawable.banner_top);

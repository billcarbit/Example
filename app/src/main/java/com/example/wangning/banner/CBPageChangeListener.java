...
public class CBPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    private ConvenientBanner.PageChangeCallBack pageChangeCallBack;
    public CBPageChangeListener(ArrayList<ImageView> pointViews, int page_indicatorId[], ConvenientBanner.PageChangeCallBack pageChangeCallBack){
    ...
    public void onPageSelected(int index) {
        ...
        if(pageChangeCallBack != null){
            pageChangeCallBack.changeIndex(index);
        }
    }
}

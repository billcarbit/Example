package com.example.wangning.searchview;
...
public class SearchView extends EditText {
    ...
    private void InitResource(Context context, AttributeSet attrs) {
        ...
        textColor = mTypedArray.getColor(R.styleable.searchedit_textColor_1, 0xFF848484);
        textSize = mTypedArray.getDimension(R.styleable.searchedit_textSize_1, 14 * density + 0.5F);
        mTypedArray.recycle();
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (mDrawable == null) {
            try {
                mDrawable = getContext().getResources().getDrawable(R.mipmap.ic_launcher);
